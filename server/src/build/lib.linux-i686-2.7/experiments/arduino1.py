...
class Arduino1Experiment(Experiment.Experiment):
    def __init__(self, coord_address, locator, cfg_manager, *args, **kwargs):
        super(Arduino1Experiment, self).__init__(*args, **kwargs)
        ...
        self.arduinocompilepath   = cfg_manager.get_value("ArduinoComplilePath", "/dev/usb1")
        ...
        if self.verbose:
            print ("arduino_port - %s | arduinocompilepath -%s | arduinobaseboard_port %s"%(self.arduino_port,self.arduinocompilepath,self.arduinobaseboard_port) )
